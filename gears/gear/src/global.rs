...
pub static mut RTL_QUERY_PERFORMANCE_COUNTER_HACKER:Lazy<SpeedHackers<i64>>=Lazy::new(|| SpeedHackers::new(1.0,0,0));
pub static mut GET_TICK_COUNT:Lazy<SpeedHackers<i32>>=Lazy::new(|| SpeedHackers::new(1.0,0,0));
pub static mut GET_TICK_COUNT64:Lazy<SpeedHackers<i64>>=Lazy::new(|| SpeedHackers::new(1.0,0,0));
